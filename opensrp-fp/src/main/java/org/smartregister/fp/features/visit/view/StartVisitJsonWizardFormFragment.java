...
public class StartVisitJsonWizardFormFragment extends JsonWizardFormFragment {
    ...
    private Contact getContact() {
        if (getActivity() != null && getActivity() instanceof StartVisitJsonFormActivity) {
            return ((StartVisitJsonFormActivity) getActivity()).getContact();
        }
        return null;
    }
    ...
    public void setJsonFormFragment(StartVisitJsonWizardFormFragment formFragment) {
        this.formFragment = formFragment;
    }

    @Override
    public StartVisitJsonWizardFormFragment getJsonFormFragment() {
        return formFragment;
    }
