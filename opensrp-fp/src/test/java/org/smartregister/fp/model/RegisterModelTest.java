package org.smartregister.fp.model;
...
public class RegisterModelTest extends BaseUnitTest {
    ...
    private String jsonString = "{\n" +
            "  \"count\": \"1\",\n" +
            "  \"encounter_type\": \"FP Registration\",\n" +
            "  \"entity_id\": \"\",\n" +
            "  \"relational_id\": \"\",\n" +
            "  \"metadata\": {\n" +
            "    \"start\": {\n" +
            ...
            "        \"v_numeric\": {\n" +
            "          \"value\": \"true\",\n" +
            "          \"err\": \"Please enter a valid FP ID\"\n" +
            "        },\n" +
            "        \"v_required\": {\n" +
            "          \"value\": \"true\",\n" +
            "          \"err\": \"Please enter the Woman's FP ID\"\n" +
            "        },\n" +
            "        \"value\": \"1723154\"\n" +
            "      },\n" +
            "      {\n" +
    ...
    private void assertRegistrations(Client client, Event event) {
        ...
        Assert.assertEquals("1723154", client.getIdentifier("FP_ID"));
        Assert.assertEquals(FPJsonFormUtils.formatDate("25-07-2003", true), client.getBirthdate());
        ...
        Assert.assertEquals("FP Registration", event.getEventType());
        Assert.assertEquals("ec_woman", event.getEntityType());
        Assert.assertEquals(FPJsonFormUtils.formatDate("25-07-2018", true), event.getEventDate());
    }
    ...
    public void testFormAsJson() throws Exception {
        ...
        Assert.assertNotEquals(currentLocationId,
                jsonInMock.getJSONObject(FPJsonFormUtils.METADATA).getString(FPJsonFormUtils.ENCOUNTER_LOCATION));
        ...
        Assert.assertEquals(currentLocationId,
                actualJson.getJSONObject(FPJsonFormUtils.METADATA).getString(FPJsonFormUtils.ENCOUNTER_LOCATION));
